...
class AddClass(CTkFrame):
    def __init__(self, parent):
        ...
        self.leftlabel = CTkLabel(
            self,
            text="",
            image=CTkImage(size=(320, 420), light_image=self.img,
                           dark_image=self.img),
            corner_radius=3,
        )
        ...
        # right pane
        self.frame = CTkFrame(self, corner_radius=10, fg_color=("green", "green"))
        ...
        self.ask.grid(row=2, column=0, pady=(5, 0), padx=50, sticky="ew")
        ...
        self.registerbutton.grid(
            row=12, column=0, padx=50, pady=(0, 0), sticky="ew")
    ...
    def themeswap(self):
        set_appearance_mode("dark" if self.switch_var.get()
                            == "off" else "light")
